use crate::{RequestContex, dto::user_dto::output::PrivilegeUserOutput, error::{AppResult, ApplicationError}, ports::{SortBy, UserRepository}};
...
impl<R: UserRepository> ListUserPrivilegeUseCase<R> {
    pub async fn execute(&self, ctx: RequestContex, sort_by: &[SortBy], page: u32, page_size: u32) -> AppResult<Vec<PrivilegeUserOutput>> {
