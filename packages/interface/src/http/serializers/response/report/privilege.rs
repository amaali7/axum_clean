...
use application::dto::report_dto::output::{
    PreivilegeReportContentOutput, PreivilegeReportOutput, PreivilegeReviewCommentOutput,
};
...
/// Preivilege User Report Response
pub struct PreivilegeReportResponse {
    pub id: InterfaceReportId,
    pub title: InterfaceTitle,
    pub content: PreivilegeReportContentResponse,
...
pub struct PreivilegeReportContentResponse {
    pub body: InterfaceBody,
    pub attachments: Vec<InterfaceUrl>, // URLs or paths to attachments
    pub review_comments: Vec<PreivilegeReviewCommentResponse>,
    pub rejection_reason: Option<InterfaceComment>,
}

pub struct PreivilegeReviewCommentResponse {
    pub reviewer_id: InterfaceUserId,
    pub comment: InterfaceComment,
    pub created_at: InterfaceDateTime,
}

impl TryFrom<PreivilegeReportOutput> for PreivilegeReportResponse {
    type Error = InterfaceError;

    fn try_from(value: PreivilegeReportOutput) -> InterfaceResult<Self> {
        Ok(Self {
...
impl TryFrom<PreivilegeReportContentOutput> for PreivilegeReportContentResponse {
    type Error = InterfaceError;

    fn try_from(value: PreivilegeReportContentOutput) -> InterfaceResult<Self> {
        Ok(Self {
...
impl TryFrom<PreivilegeReviewCommentOutput> for PreivilegeReviewCommentResponse {
    type Error = InterfaceError;

    fn try_from(value: PreivilegeReviewCommentOutput) -> InterfaceResult<Self> {
        Ok(Self {
